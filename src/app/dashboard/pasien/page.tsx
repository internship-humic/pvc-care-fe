    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-slate-900">
      ...
      <nav className="bg-white border-b border-slate-200/80 sticky top-0 z-40 px-6 lg:px-10 py-4 flex justify-between items-center shadow-sm">
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Link href="/dashboard/dokter" className="flex items-center gap-2 px-5 py-2 text-slate-600 hover:bg-slate-100 rounded-full text-sm font-medium transition">
            👥 Kelola Dokter
          </Link>
          <Link href="/dashboard/pasien" className="flex items-center gap-2 px-5 py-2 bg-[#4880FF] text-white rounded-full text-sm font-semibold shadow-sm transition hover:bg-blue-600">
            🏥 Kelola Pasien
          </Link>
        </div>
