              ...
              patients.map((patient) => (
                <div key={patient.id} className="grid grid-cols-12 gap-4 items-center px-8 py-4 hover:bg-slate-50/50 transition-colors duration-200">
                  ...
                  <div className="col-span-1 text-right flex justify-end">
                    <Link href="/verifikasi" className="flex items-center gap-1.5 text-[#4880FF] hover:text-blue-700 hover:bg-blue-50 px-3 py-1.5 rounded-lg transition-colors text-sm font-bold">
